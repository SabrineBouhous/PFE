...
<head>
    ...
    <title>Planning présentiel</title> 
...
if ($resquete8->execute()) {?>
  ...
  <html>
<head>
<meta http-equiv="refresh" content="0;url=Planning_présentiel.php?id=<?php echo $id;?>">
</head>
</html>
<?php }else{?>
  <script>
