...
<div>
      <div class="page-title">
       <h2> <i class="fas fa-file"></i> Archive des PVs d'envoi</h2>
        <ol class="breadcrumb" style="width:100%;height:45px; background-color: #b2b2b2;color: white">
         <li class="active" style="width:100%;"><a href="dashboard.php?id=<?php echo $id ?>" ><i class="fas fa-home"></i> Aceuil</a>/ <a href="">Gestion des archives</a> / <a href=""> Archive des PV d'envoi</a> <div id="reportrange" class="btn btn-green btn-square date-picker" style="margin-left:45%;font-size: 15px;display: inline;">
