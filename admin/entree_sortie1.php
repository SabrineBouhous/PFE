...
$nbr=0;
 	 ...
 	 $prof = $pdo->query("SELECT * FROM employé INNER JOIN entrée_sortie ON(employé.idemp=entrée_sortie.idemp) WHERE employé.Emploi ='$Emploi' ");
...
$ap="";
 ...
 $pdf->Cell(8,10,$nbr,1,0);
 $pdf->SetFont('Arial','',10);
$pdf->Cell(30,10,$resultat[$key]['Nom']." ".$resultat[$key]['Prénom'],1,0,'C');
$pdf->Cell(30,10,$resultat[$key]['entrée'],1,0,'C');
$pdf->Cell(20,10,$resultat[$key]['date_entree'],1,0,'C');
$pdf->Cell(20,10,$ap,1,0,'C');
$pdf->Cell(10,10,$resultat[$key]['date_sortie'],1,0,'C');
$pdf->Cell(40,10,$ap,1,1,'C');
