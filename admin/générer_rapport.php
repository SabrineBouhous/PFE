...
// Chargement des données
 ...
 $pdf->AddPage('L');
$nbr=0;
 $query1 = $pdo->query("SELECT * FROM  fonction INNER JOIN employé ON(employé.id_fonction=fonction.id_fonction) INNER JOIN grade ON(employé.Grade=grade.id_grade) Where Emploi != 'Professeur' ");
