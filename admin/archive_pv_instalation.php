...
<div>
      <div class="page-title">
       <h2> <i class="fas fa-file"></i> Archive des PVs d'installations</h2>
        <ol class="breadcrumb" style="width:100%;height:45px; background-color: #b2b2b2;color: white">
         <li class="active" style="width:100%;"><a href="dashboard.php?id=<?php echo $id ?>" ><i class="fas fa-home"></i> Aceuil</a>/ <a href="">Gestion des archives</a> / <a href="">  <i class="fas fa-file"></i> Archive des PV d'installations</a> <div id="reportrange" class="btn btn-green btn-square date-picker" style="margin-left:40%;font-size: 15px;display: inline;">
...
<table id="example" class="table table-striped table-bordered table-list-search" style=" padding-right: 10px;width:100%; background-color:white;text-align: center;">  
        ...
        <tbody>
         <?php
          $nom_repertoire ="..Document_employé/pv_instalation";
