...
<div>
      <div class="page-title">
       <h2> <i class="fas fa-file"></i> Archive des PVs des avertissements</h2>
        <ol class="breadcrumb" style="width:100%;height:45px; background-color: #b2b2b2;color: white">
         <li class="active" style="width:100%;"><a href="dashboard.php?id=<?php echo $id ?>" ><i class="fas fa-home"></i> Aceuil</a>/ <a href="">Gestion des archives</a> / <a href="">  <i class="fas fa-file"></i> Archive des PV des avertissements</a> <div id="reportrange" class="btn btn-green btn-square date-picker" style="margin-left:40%;font-size: 15px;display: inline;">
