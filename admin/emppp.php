...
if($num_of_rows>0){
  ...
  if($resquete->execute()){
    $message='<div class="alert alert-success"> Employé ajouté avec  <strong> succés!</strong> !</div>';

  }else{
  $message='<div class="alert alert-danger"> erreur est survenue , veillez  réessayer !</div>';
...
<body>
 ...
 <div class="container" style="background-color: transparent;margin-left: 10%;margin-bottom: 30px; font-size: 35px; font-weight: bold; ">Liste des Employés
</div>

<div class="container" style="width: 920px;margin-left:10.5%;margin-bottom: 30px; height: 40px; background-color: #b2b2b2;color: white; font-size: 20px; font-weight: bold"><a  style="text-decoration: none; color: white;"  href="dashboard_user.php?id= <?php echo $id ?>">Dashoard</a> / <a style="text-decoration: none; color: white;" href="">Gestion des employés</a>
</div>    
...
<a 
                        href="emppp.php?#popup3"
                        type="button" rel="tooltip" class="btn button" style="background-color: green; width: 100px; height: 35px;
                        color: white; margin-left: 820px;"> ajouter
                        </a>   



  <form method="POST">
   <button class="btn btn-danger" type="submit" name="supprimer" style="margin-left: 820px;">Supprimer </button>
   <div class="grid-container" style="margin-left:2%">
...
box-shadow: 1px 1px 5px 0px rgba(173,168,173,1); width: 1000px; padding-left: 20px; padding-right: 20px; margin-left: 2%; margin-bottom: 20px;">
  
<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%"  style=" padding-right: 10px;width: 1000px; background-color:white;text-align: center;">
...
<a href="emppp.php?id=<?php echo $_GET['id']?>" ><button class="btn button" type="submit" name="submit1" style="background-color: grey; color: white" onclick="
let timerInterval
Swal.fire({
...
<div id="popup3" class="overlay" style="background-color: white">
  <div class="popup" style="width: 70%;font-size:15px"><br/>
    <div style="background-color: #bc5a45; height:8%;width:104.5%;margin-top:-4.80%;margin-left:-2.2%;text-align: center;padding-top:5px">
     <h3 style=" color: white;display: inline;"><i>Ajouter un nouveau employé</i></h3>
     <a class="close" href="emppp.php" style="font-size:45px;color: white">×</a><br>
      </div>
