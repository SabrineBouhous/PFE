...
<div class="container">
    ...
    <div class="invalid-feedback" id="errorfa">
          Ce champs est obligatoire !!
                                ...
                                <div class="text-center">
                                    <button type="button" style="width: 40% ;margin-left: 30%" value="next" class="btn btn-info btn-block rounded-0 py-2" onclick="showdiv2()">Suivant</button>
                                </div>
                            </div>
    ...
    <p><input type="Date" class="form-control"  name="finsem2" id="finsem2"></p>
      <div class="invalid-feedback" id="errorfs2">
          Ce champs est obligatoire !!
                                ...
                                <div class="text-center" >
                                  <button type="button" value="previous" class="btn btn-info  rounded-0 " onclick="showdiv1()" style="width:30%;display: inline;">Précedent</button>
                                    <button type="button" value="next" class="btn btn-info  rounded-0 " onclick="showdiv3()"  style="width:30%;display: inline;">Suivant</button>
  ...
  <?php } ?>
                                ...
                                <div class="text-center">
                                  <button type="button" value="previous" class="btn btn-info btn-block rounded-0 py-2" onclick="showdiv22()" style="width:30%;display: inline;">Précedent</button>
                                    <button type="submit" name="envoyer" id="envoyerr" hidden >a</button>

                                    <button type="submit"  value="next" id="envoy" class="btn btn-info btn-block rounded-0 py-2" onclick="env()" style="width:30%;display: inline;">Envoyer</button>
                                </div>
                            </div>
