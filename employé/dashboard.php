...
<div class="col-lg-3 col-sm-6" style="margin-right:5%;">
                        <div class="circle-tile" >
                            <a href="../employé/mesinfo.php?id=<?php echo $id ; ?>">
                            ...
                            <div class="circle-tile-content dark-blue" style="background-color:#fd7965">
                                ...
                                <a href="page_help_employé.php?id=<?php echo $id ; ?>" class="circle-tile-footer">Plus d'infos <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
<div class="col-lg-3 col-sm-6" style="margin-right:5%">
                        <div class="circle-tile">
                            <a href="../employé/mescongé.php?id=<?php echo $id ; ?>">
                            ...
                            <div class="circle-tile-content"  style="background-color:#ca88f3">
                                ...
                                <div class="circle-tile-number text-faded">
                                  <?php  
                                  $docu = $pdo->query("SELECT * FROM `congé`");
                                  $docu = $docu->fetchAll();
                                  $doc = count($docu); 
                                  echo $doc." "."congés pris";
                                  ?>
                                    <span id="sparklineB"></span>
                                </div>
                                <a href="page_help_employé.php?id=<?php echo $id ; ?>" class="circle-tile-footer">Plus d'info <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
